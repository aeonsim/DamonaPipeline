...
CRAMNAME=`echo ${BAMS[$SLURM_ARRAY_TASK_ID]} | awk '{n=split($0,arra,"/"); gsub("cram","bam",arra[n]); print(arra[n])}'`

echo "Convert to Cram ${CRAMNAME}"
$JAVA -Xmx15g -jar ${CRAM} bam -R ${REF} -b -O ${CRAMNAME} -I ${BAMS[$SLURM_ARRAY_TASK_ID]}

# java -jar ../bams/cramtools-2.0.jar bam -R ~/refs/bosTau6.fasta -b -I /home/projects/bos_taurus/damona/crams/LIC_TRIO/21930910_LIC_TRIO_L004_BQSR.cram  -O 21930910_LIC_TRIO_L004_BQSR.bam
